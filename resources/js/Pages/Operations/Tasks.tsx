...
export default function Tasks() {
    return (
        <ModulePage
            title="Quick Tasks"
            description="Create, assign, and track tasks with sub-tasks, attachments, and real-time progress monitoring."
            icon={<TasksIcon />}
            phase="Phase 1"
            features={[
                'Create & assign tasks to individuals or teams',
                ...
                'Progress dashboards & overdue alerts',
            ]}
        />
    );
}
