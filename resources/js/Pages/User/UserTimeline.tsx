...
const typeConfig: Record<string, { icon: string; color: string; label: string }> = {
    hired: { icon: '🎉', color: 'bg-green-100 text-green-700', label: 'Hired' },
    promotion: { icon: '⬆️', color: 'bg-blue-100 text-blue-700', label: 'Promotion' },
    role_change: { icon: '🔄', color: 'bg-indigo-100 text-indigo-700', label: 'Role Change' },
    department_change: { icon: '🏢', color: 'bg-purple-100 text-purple-700', label: 'Dept Change' },
    salary_change: { icon: '💰', color: 'bg-yellow-100 text-yellow-700', label: 'Salary Change' },
    review: { icon: '📋', color: 'bg-orange-100 text-orange-700', label: 'Review' },
    award: { icon: '🏆', color: 'bg-amber-100 text-amber-700', label: 'Award' },
    training: { icon: '📚', color: 'bg-cyan-100 text-cyan-700', label: 'Training' },
    probation_end: { icon: '✅', color: 'bg-emerald-100 text-emerald-700', label: 'Probation End' },
    anniversary: { icon: '🎂', color: 'bg-pink-100 text-pink-700', label: 'Anniversary' },
    termination: { icon: '👋', color: 'bg-red-100 text-red-700', label: 'Termination' },
    custom: { icon: '📌', color: 'bg-slate-100 text-slate-600', label: 'Milestone' },
};
